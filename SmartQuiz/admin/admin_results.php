...
<style>
    ...
    .card { border-radius: 15px; box-shadow: 0 6px 15px rgba(0,0,0,0.1); padding: 25px; }
    .table thead { background: #5563DE; color: #fff; }
    .table tbody tr:hover { background: rgba(85, 99, 222, 0.1); }
    .filters .form-control, .filters .form-select, .filters .btn { margin-bottom: 10px; }
    .filters .input-group-text { background-color: #5563DE; color: #fff; border: none; }
    .filters .btn-reset { background-color: #74ABE2; color: #fff; }
    @media (max-width: 768px) {
        .filters .col-md-2, .filters .col-md-3, .filters .col-md-1 { flex: 0 0 100%; max-width: 100%; }
    }
</style>
</head>
<body>
...
<div class="container mt-5">
    <div class="card">
        ...
        <div class="row g-2 mb-4 filters">
            ...
            <div class="col-md-1">
                <input type="number" id="minScore" class="form-control" placeholder="Min" min="0">
            </div>

            <div class="col-md-1">
                <input type="number" id="maxScore" class="form-control" placeholder="Max" min="0">
            </div>

            <div class="col-md-12 d-flex justify-content-end">
                <button class="btn btn-reset px-4" id="resetFilters"><i class="bi bi-arrow-counterclockwise"></i> Reset</button>
            </div>
        </div>
